                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input class="form-control tx-uppercase" id="cur_fechaini" type="date" name="cur_fechaini" required/>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Fecha Fin: <span class="tx-danger">*</span></label>
                            <input class="form-control tx-uppercase" id="cur_fechafin" type="date" name="cur_fechafin" required/>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Instructor: <span class="tx-danger">*</span></label>
                            <select class="form-control select2" style="width:100%" name="ins_id" id="ins_id" data-placeholder="Seleccione">
                                <option label="Seleccione"></option>
