    ...
    $('#cur_id').on('change',function(){
        $("#cur_id option:selected").each(function(){
            ...
            $('#detalle_data').DataTable({
                ...
                "ajax":{
                    url:"../../controlador/usuario.php?op=listar_cursos_usuario",
                    type:"post",
                    data:{cur_id:cur_id},
                },
                "bDestroy": true,
...
function eliminar(curdet_id){
    swal.fire({
        ...
        if (result.value) {
            $.post("../../controlador/curso.php?op=eliminar_curso_usuario",{curdet_id : curdet_id}, function (data) {
...
function combo_curso(){
    $.post("../../controlador/curso.php?op=combo", function (data) {
        $('#cur_id').html(data);
    });
}
function certificado(curdet_id){
    console.log(curdet_id);
    window.open('../certificado/index.php?curdet_id='+curdet_id+'','_blank');
}
function nuevo(){
    if ($('#cur_id').val()==''){
        Swal.fire({
...
function listar_usuario(cur_id){
    $('#usuario_data').DataTable({
        ...
        "ajax":{
            url:"../../controlador/usuario.php?op=listar_detalle_usuario",
            type:"post",
            data:{cur_id:cur_id}
        },
        "bDestroy": true,
...
function registrardetalle(){
    ...
    if (usu_id == 0){
        ...
        $.ajax({
            url: "../../controlador/curso.php?op=insert_curso_usuario",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
            success : function(data) {
               ...
               /*  data.forEach(e => {
                    e.forEach(i => {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "../../controlador/curso.php?op=generar_qr",
