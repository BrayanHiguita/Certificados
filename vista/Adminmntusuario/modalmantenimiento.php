            ...
            <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input class="form-control tx-uppercase" id="usu_apellip" type="text" name="usu_apellip" required/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input class="form-control tx-uppercase" id="usu_apellim" type="text" name="usu_apellim" required/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input class="form-control tx-uppercase" id="usu_contra" type="text" name="usu_contra" required/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input class="form-control tx-uppercase" id="usu_telefono" type="text" name="usu_telefono" required/>
                        </div>
                    </div>
