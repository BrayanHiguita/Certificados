...
<html lang="es">
  <head>
    ...
    <title>Sistema de Generación de Archivos</title>
    ...
    <div class="d-flex align-items-center justify-content-center bg-br-primary ht-100v">
      <form action="" method="post">
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
          <div class="signin-logo tx-center tx-28 tx-bold tx-inverse"><span class="tx-normal">[</span> Santo Tomás <span class="tx-normal">]</span></div>
          ...
          <div class="form-group">
            <input type="password" id="usu_contra" name="usu_contra" class="form-control" placeholder="Ingrese Contraseña">
          </div>
